...
function Task:copy()
  ...
  return Promise.resolve(old and new and self.do_copy and fileops.copy_directory(old, new, {
    parents = true,
    keep_times = true,
...
function Task:delete()
  local old = self.old_dir
  return Promise.resolve(old and self.do_delete and fileops.remove_directory(old, { recursive = true }))
end
